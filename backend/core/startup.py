...
async def startup_checks() -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info(f"Running check: {check.description}")
        try:
            from storage.firestore_client import test_firestore_connection
        ...
        logger.info(f"Running check: {check.description}")
        try:
            from storage.firestore_client import initialize_collections
...
async def health_check() -> Dict[str, Any]:
    ...
    try:
        from core.config import settings, is_render_deployment
...
def get_system_info() -> Dict[str, Any]:
    ...
    try:
        from core.config import get_configuration_summary, is_render_deployment
